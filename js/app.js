...
(function(){
  ...
  function productCard(p){
    ...
    return `<article class="product-card product-card-v178 product-card-v190 product-card-v235 ${isOut?'is-out is-agotado':''}" data-id="${id}" data-product-id="${id}" data-stock-status="${st.cls}" data-product-name="${escapeHtml(p.name||'')}" data-product-price="${escapeHtml(String(p.price||0))}" data-product-stock="${escapeHtml(String(stockQty))}">
      ${outRibbon}
