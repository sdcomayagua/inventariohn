  ...
  function openProductEditor(id){
    ...
    $('#saveProduct').onclick=async()=>{
      ...
      try{
        ...
        setProductSaveStatus('No se confirmó Firebase: '+(err.message||err)+'. El producto quedó guardado en este dispositivo. Revisa la conexión y toca Guardar otra vez.', 'error');
        toast('No se confirmó Firebase. Revisa el mensaje del formulario.');
      }finally{
        productSaving=false;
