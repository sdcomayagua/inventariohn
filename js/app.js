(function(){
  ...
  const SHIPPING = {
    normal: { type:'Normal', label:'Depósito', fee:100, cod:false, note:'Producto + Lps. 100 de envío. Pago por depósito o Tigo Money.' },
    cod: { type:'COD', label:'Pagar al recibir', fee:100, cod:true, note:'Producto + Lps. 100 de envío + comisión 6%. Total redondeado.' },
  ...
  function autoProductSpecs(p={}){
    return {estado:'Nuevo',categoria:firstTag(p)||'General',pais:'Honduras',envios:'Normal Lps.100 · Pagar al Recibir Lps.100 + 6% · Local por definir'};
  }
  ...
  function emptyQuote(){return {id:'COT-'+Date.now(),items:[],client:'',phone:'',department:'Comayagua',municipality:'Comayagua',reference:'',shippingType:'Normal',company:'Forza',shipping:SHIPPING.normal.fee,cod:false,discount:0,date:new Date().toISOString(),saved:false,qtyMap:{}}}
  ...
  function promoWhatsAppLines(p){
    ...
    return rows.map(r=>`• ${num(r.qty)} ${r.qty===1?'unidad':'unidades'}: Producto ${money(r.price)} | Depósito ${money(r.price+100)} | Pagar al Recibir ${money(Math.round((r.price+100)*(1+((state.settings.codPercent||6)/100))))}`).join('\n');
  }
      ...
      <div class="modal-body v49-product-detail">
        ...
        <section class="v49-tab active" data-panel="cliente">
          ...
          <div class="v49-price-cards">
            ...
            <div><span>Pagar al recibir</span><b data-v49-total="cod">${money(cod)}</b><small>Producto + Lps. 100 + comisión 6%</small></div>
      ...
      <div class="productPhotoClean productPhotoClean-v49 productPhotoClean-v498" data-export="product-photo-clean">
        ...
        <div class="productPhotoBody">
          ...
          <div class="productPhotoPrices">
            <div><span>Depósito / Tigo Money</span><b>${money(normal)}</b><small>Producto + Lps. 100</small></div>
            <div><span>Pagar al recibir</span><b>${money(cod)}</b><small>Producto + Lps. 100 + 6%</small></div>
  ...
  function receiptLandscapeCSS(){return `
    ...
    .receiptPage-v50 *{box-sizing:border-box}.rp-top{height:82px;margin:0 -42px 28px;background:linear-gradient(135deg,#07131a,#16231f);color:white;display:flex;align-items:center;justify-content:space-between;padding:0 42px;border-bottom:7px solid #d4b35f}.rp-top span{font-size:26px;text-transform:uppercase;letter-spacing:.18em;font-weight:950}.rp-top>b{background:#e9d38b;color:#102018;border-radius:999px;padding:16px 30px;text-transform:uppercase;letter-spacing:.11em;font-size:22px;box-shadow:0 10px 30px rgba(0,0,0,.12)}.rp-hero{display:grid;grid-template-columns:1fr 430px;gap:28px;margin-bottom:20px}.rp-brand,.rp-total,.rp-info>div,.rp-payment,.rp-products,.rp-summary,.rp-footer{background:white;border:1px solid #dfe7df;border-radius:28px}.rp-brand{display:flex;align-items:center;gap:26px;padding:26px 30px}.rp-brand img{width:116px;height:116px;object-fit:contain;background:white;border:1px solid #dce6df;border-radius:24px;padding:7px;box-shadow:0 14px 34px rgba(20,26,22,.10)}.rp-brand small,.rp-total span,.rp-info span,.rp-payment span,.rp-summary span,.rp-section-head span{display:block;text-transform:uppercase;letter-spacing:.16em;color:#76816f;font-size:18px;font-weight:950}.rp-brand small{font-size:21px;color:#8a9488}.rp-brand h1{margin:2px 0 7px;font-size:66px;line-height:.86;letter-spacing:-.055em;color:#07131a}.rp-brand p{margin:2px 0;color:#4c5c55;font-size:24px;font-weight:900;line-height:1.06}.rp-total{background:linear-gradient(135deg,#fbf5de,#eefbf0);border-color:#ded2aa;padding:34px 32px;display:flex;flex-direction:column;justify-content:center}.rp-total b{display:block;font-size:86px;line-height:.92;letter-spacing:-.075em;color:#07131a;margin-top:16px;white-space:nowrap}.rp-info{display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:16px;margin-bottom:18px}.rp-info>div{padding:18px 20px;min-height:94px}.rp-info b{display:block;color:#07131a;font-size:22px;line-height:1.08;margin-top:9px}.rp-payment{display:grid;grid-template-columns:310px 1fr;gap:18px;align-items:center;background:#f4fff7;border-color:#c9ebd2;padding:22px 24px;margin-bottom:18px}.rp-payment b{display:block;color:#07131a;font-size:28px;margin-top:8px}.rp-payment p{margin:0;color:#354942;font-size:23px;line-height:1.25;font-weight:850}.rp-products{overflow:hidden;margin-bottom:18px}.rp-section-head{height:70px;background:linear-gradient(135deg,#07131a,#16231f);color:white;display:flex;align-items:center;justify-content:space-between;padding:0 28px}.rp-section-head span{color:white}.rp-section-head b{color:#e9d38b;font-size:22px;text-transform:uppercase;letter-spacing:.08em}.rp-lines{background:#fff}.rp-row{display:grid;grid-template-columns:58px 76px 1fr 150px;align-items:center;gap:16px;min-height:86px;padding:10px 26px;border-top:1px solid #ebefe9}.rp-row:first-child{border-top:0}.rp-row img{width:76px;height:76px;object-fit:cover;border-radius:16px;background:#f2f6ef}.rp-num{width:50px;height:50px;border-radius:16px;background:#f2f7f0;display:grid;place-items:center;font-weight:950;color:#1b6b4d;font-size:20px}.rp-prod{min-width:0}.rp-row b{display:block;color:#07131a;font-size:22px;line-height:1.05;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.rp-row small{display:block;color:#5e7068;font-size:16px;font-weight:850;margin-top:5px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.rp-row strong{text-align:right;color:#07131a;font-size:25px;white-space:nowrap}.rp-more{padding:12px 26px;background:#fbfaf4;color:#4d5a51;font-weight:900;font-size:18px;border-top:1px solid #ebefe9}.rp-empty{padding:24px;color:#617167;font-weight:900}.rp-summary{overflow:hidden;margin-bottom:18px}.rp-summary>div{display:flex;align-items:center;justify-content:space-between;min-height:62px;padding:0 28px;border-top:1px solid #ebefe9}.rp-summary>div:first-child{border-top:0}.rp-summary b{font-size:28px;color:#07131a;white-space:nowrap}.rp-summary .grand{min-height:88px;background:linear-gradient(135deg,#07131a,#17231d);color:#fff}.rp-summary .grand span{color:white}.rp-summary .grand b{font-size:60px;color:#e9d38b;letter-spacing:-.06em}.rp-footer{display:grid;grid-template-columns:1fr auto;gap:22px;align-items:center;padding:24px 30px;min-height:110px}.rp-footer p{margin:0;color:#344842;font-size:23px;line-height:1.22;font-weight:850}.rp-footer b{border:1px solid #d8e8d5;background:#f8fff5;color:#1d6a4d;border-radius:999px;padding:14px 24px;font-size:21px;white-space:nowrap}
  ...
  async function printDocumentCard(isSale=false){
    ...
    try{
      ...
      const html=`<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${title}</title><style>
        @page{size:letter portrait;margin:0}*{box-sizing:border-box}html,body{margin:0!important;padding:0!important;width:100%!important;height:100%!important;background:#fff;color:#061522;overflow:hidden!important}body{display:block!important}.paper{position:fixed!important;inset:0!important;width:100vw!important;height:100vh!important;margin:0!important;padding:0!important;background:#fff!important;display:flex!important;align-items:center!important;justify-content:center!important;overflow:hidden!important}.paper img{display:block!important;width:auto!important;height:100vh!important;max-width:100vw!important;max-height:100vh!important;object-fit:contain!important;background:#fff!important;page-break-before:avoid!important;page-break-after:avoid!important;page-break-inside:avoid!important}.hint{display:none}@media screen{html,body{overflow:auto!important;background:#e9efe9!important}.paper{position:relative!important;inset:auto!important;min-height:100vh!important;box-shadow:0 18px 50px rgba(0,0,0,.18)}}@media print{html,body{overflow:hidden!important}.paper{break-inside:avoid!important;page-break-inside:avoid!important}.paper img{break-inside:avoid!important;page-break-inside:avoid!important}}
