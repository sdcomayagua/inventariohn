(function(){
  ...
  function currentAppearance(){
    const mode=String(state.settings.appearance||'gamer').trim();
    return mode==='pro-white'?'pro-white':'gamer';
  }
  function applyAppearance(){
    const mode=currentAppearance();
    document.body.classList.toggle('pro-mode',mode==='pro-white');
    document.body.classList.toggle('pro-white-mode',mode==='pro-white');
    document.body.classList.toggle('turbo-mode',false);
    document.body.classList.toggle('gamer-mode',mode==='gamer');
  ...
  function setAppearance(mode){
    state.settings.appearance=mode==='pro-white'?'pro-white':'gamer';
    save();
    applyAppearance();
    render();
    toast(state.settings.appearance==='pro-white'?'Modo PRO blanco activado.':'Modo GAMER activado.');
  }
  function toggleAppearance(){setAppearance(currentAppearance()==='gamer'?'pro-white':'gamer');}
  ...
  function mainAction(e){
    ...
    if(a==='themeGamer') return setAppearance('gamer');
    if(a==='themePro') return setAppearance('pro-white');
