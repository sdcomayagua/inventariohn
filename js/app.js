...
(function(){
        ...
        <div class="v141-detail-shell v163-detail-shell">
          ...
          <section class="v49-tab active" data-panel="cliente">
            <div class="v250-detail-route-switch" role="tablist" aria-label="Ruta del cliente">
              <button type="button" class="${routeMode==='local'?'active':''}" data-v49-route="local">Comayagua</button>
              <button type="button" class="${routeMode==='hn'?'active':''}" data-v49-route="hn">Honduras</button>
            </div>
            ...
            <div class="v49-price-cards v141-price-cards v163-price-cards v164-sale-buttons v250-price-cards" data-v49-route-wrap="${routeMode}">
              <button type="button" class="v164-price-option ${routeMode==='local'?'is-main is-current':''}" data-v49-card="local"><span>Comayagua</span><b data-v49-total="local">${money(local)}</b><small>Precio local · según zona</small></button>
              <button type="button" class="v164-price-option ${routeMode==='hn'?'is-main is-current':''}" data-v49-card="normal"><span>Honduras / normal</span><b data-v49-total="normal">${money(normal)}</b><small>Depósito / Tigo Money</small></button>
              <button type="button" class="v164-price-option" data-v49-card="cod"><span>Pagar al recibir</span><b data-v49-total="cod">${money(cod)}</b><small>Envío + comisión 10%</small></button>
            </div>
  ...
  function bindProductDetails(p){
    ...
    const syncRouteUI=()=>{
      modalRoot.querySelectorAll('[data-v49-route]').forEach(btn=>btn.classList.toggle('active',btn.dataset.v49Route===routeMode));
      modalRoot.querySelectorAll('[data-v49-card]').forEach(card=>card.classList.toggle('is-current', card.dataset.v49Card===('local'===routeMode?'local':'normal')));
    ...
    $$('[data-v49-route]',modalRoot).forEach(btn=>btn.addEventListener('click',()=>{ routeMode=btn.dataset.v49Route==='local'?'local':'hn'; setProductDeliveryMode(p.id,routeMode); redrawTotals(); }));
    redrawTotals();
