    ...
    return `<section class="hero v51-hero hero-v56-clean home-hero-v87 home-hero-v94" id="inicio">
      ...
      <div class="v51-hero-shell home-hero-shell-v87 home-hero-shell-v94">
        <div class="home-brand-card-v94">
          <div class="home-kicker-v94"><span></span> Panel conectado a Google Sheets</div>
          <h2>Ventas, cotizaciones e inventario sin enredos.</h2>
          <p>Catálogo 2026 cargado, acciones grandes para móvil y sincronización directa con Apps Script.</p>
          <div class="home-sync-row-v94">
            <span><b>CODE.GS</b> /exec activo</span>
            <span><b>${escapeHtml(sync)}</b></span>
            <span><b>${num(m.total)}</b> alertas</span>
          </div>
          <div class="home-primary-actions-v94 no-print">
            <button type="button" data-action="sell" class="home-action-main-v94"><i aria-hidden="true">⚡</i><span>Vender ahora</span><small>Recibo de compra</small></button>
            <button type="button" data-action="quote" class="home-action-soft-v94"><i aria-hidden="true">🧾</i><span>Cotizar</span><small>Recibo cotización</small></button>
          </div>
        </div>
        <div class="home-actions-card-v87 home-actions-card-v94 no-print">
          ...
          <div class="v51-hero-actions home-actions-grid-v87 home-actions-grid-v94">
            ...
            <button type="button" data-action="sync" class="secondary"><i aria-hidden="true">🔄</i><span>Bajar Sheets</span><small>Actualizar catálogo</small></button>
        ...
        <header class="receipt-header-pro">
          <div class="receipt-brand-pro">
            ...
            <div>
              ...
              <h2>${isSale?'Recibo de compra':'Cotización formal'}</h2>
              <p>${date}</p>
