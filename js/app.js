  ...
  function sectionDashboard(){
    ...
    return `<section class="section ${activateClass('dashboard')}" id="dashboard">
      <div class="hero">
        ...
        <h1>SDC POS móvil</h1>
        <p>Panel privado optimizado para Samsung S24 Ultra: rápido, limpio y listo para vender desde el teléfono.</p>
      ...
      <div class="panel">
        ...
        <div class="pos-layout">
          <div class="panel subpanel" style="margin:0">
            <div class="panel-head"><div><h2>1. Agregar productos</h2><p>Búsqueda rápida para vender desde celular.</p></div></div>
          ...
          <div class="panel subpanel" style="margin:0">
            <div class="panel-head"><div><h2>2. Cliente, envío y total</h2><p>Datos claros para la factura y el mensaje al cliente.</p></div></div>
            ${customerForm()}
