...
(function(){
  ...
  function productClientPhotoHTML(p, qty, imgOverride='', photoIndex=1, photoTotal=1){
    ...
    return `
      <div class="productPhotoClean productPhotoClean-v49 productPhotoClean-v498 productPhotoLandscape-v147" data-export="product-photo-clean">
        <div class="productPhotoHead productPhotoHead-v147"><img src="${LOGO_SRC}" crossorigin="anonymous"><div><strong>SD COMAYAGUA</strong><span>Producto para cliente</span>${photoLabel}</div><b>${st.text}</b></div>
  ...
  function openShortReceipt(isSale){
    ...
    openModal(`<div class="modal-head short-receipt-head"><h3>Recibo corto</h3><button class="close">×</button></div><div class="modal-body short-receipt-screen short-receipt-screen-v72 short-receipt-screen-v147"><div class="short-receipt-grid-v147"><section class="short-receipt-variant-v147"><div class="short-receipt-preview-wrap">${shortReceiptCardHTML(normalDoc)}</div><button class="btn secondary full" id="downloadShortNormal">Descargar normal</button></section><section class="short-receipt-variant-v147"><div class="short-receipt-preview-wrap">${shortReceiptCardHTML(codDoc)}</div><button class="btn full" id="downloadShortCOD">Descargar contra entrega</button></section></div><div class="modal-actions short-receipt-actions" style="position:static"><button class="btn secondary" id="backFromShortReceipt">← Atrás</button><button class="btn secondary" id="copyShortReceipt">Copiar texto</button></div></div>`,true);
