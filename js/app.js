...
(function(){
  ...
  function categoryQuickRailHTML(){
    ...
    return `<section class="category-selector-v195 no-print" aria-label="Categorías del catálogo">
      <button type="button" class="category-open-v195" data-action="categoriesSheet"><i aria-hidden="true">▦</i><span>Categorías</span></button>
      <div class="category-current-v195"><b>${escapeHtml(label)}</b><small>${num(activeCount)} productos · ${num(totalCats)} categorías</small></div>
    </section>`;
  }
