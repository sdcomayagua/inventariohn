...
(function(){
  ...
  function inventoryHeadHTML(count){const sheetUrl=`https://docs.google.com/spreadsheets/d/${getSheetId()}/edit`; return `<div class="section-head inventory-head-v31"><div class="inventory-head-title-row"><h2>Productos</h2><a class="btn small ghost sheets-head-btn" href="${sheetUrl}" target="_blank" rel="noopener" title="Abrir Google Sheets" aria-label="Abrir Google Sheets"><svg class="sheets-icon" viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" fill="#1a7d4a"/><rect x="7" y="7" width="4" height="2" rx=".5" fill="#fff"/><rect x="13" y="7" width="4" height="2" rx=".5" fill="#fff"/><rect x="7" y="11" width="4" height="2" rx=".5" fill="#fff"/><rect x="13" y="11" width="4" height="2" rx=".5" fill="#fff"/><rect x="7" y="15" width="4" height="2" rx=".5" fill="#fff"/><rect x="13" y="15" width="4" height="2" rx=".5" fill="#fff"/></svg><span>Sheets</span></a></div><div class="inventory-head-actions"><button class="inventory-new-btn" data-action="newProduct" type="button">+ Producto</button>${inventoryControls()}<span class="count-pill">${count} resultados</span></div></div>`}
  ...
  function quickPanel(){
    ...
    return `<section class="quick no-print quick-v22 quick-private quick-panel">
      <div class="quick-grid" aria-label="Acciones rápidas del panel">
        <button class="quick-btn" data-action="cardClient"><b>Cliente</b></button>
        <button class="quick-btn" data-action="captureClean"><b>Captura</b></button>
        <button class="quick-btn" data-action="quote"><b>Cotizar</b></button>
        <button class="quick-btn" data-action="sell"><b>Vender</b></button>
        <button class="quick-btn" data-action="catalog"><b>Catálogo</b></button>
        <button class="quick-btn" data-action="newProduct"><b>Producto</b></button>
        <button class="quick-btn" data-action="quickSale"><b>Rápida</b></button>
        <button class="quick-btn" data-action="quotes"><b>Guardadas</b></button>
        <button class="quick-btn" data-action="clients"><b>Clientes</b></button>
        <button class="quick-btn" data-action="receipts"><b>Caja</b></button>
        <button class="quick-btn" data-action="profit"><b>Ganancia</b></button>
        <button class="quick-btn" data-action="backup"><b>Respaldo</b></button>
      </div>
    </section>
  ...
  function cardModePanel(){
    ...
    return `<section class="view-mode-panel no-print"><div class="view-mode-copy"><b>Vista</b></div><div class="view-mode-buttons"><button class="${mode==='admin'&&!captureActive?'active':''}" data-action="cardAdmin">ADMIN</button><button class="${mode==='client'&&!captureActive?'active':''}" data-action="cardClient">CLIENTE</button><button class="${captureActive?'active capture-live':''}" data-action="captureClean">${captureActive?'SALIR':'CAPTURA'}</button></div></section>`
  }
