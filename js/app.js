...
(function(){
    ...
    return `<section class="hero v51-hero hero-v56-clean home-hero-v87 home-hero-v94" id="inicio">
      ...
      <div class="v51-hero-shell home-hero-shell-v87 home-hero-shell-v94">
        <div class="home-brand-card-v94">
          ...
          <h2>Inicio</h2>
          <p class="home-subline-v151">Elige vender, cotizar o revisar productos.</p>
  ...
  function shortReceiptCardHTML(doc){
    ...
    return `<div class="short-receipt short-receipt-v34 short-receipt-v36 short-receipt-v72 short-receipt-v147" id="shortReceiptCard"><div class="short-brand short-brand-v147"><div class="short-logo-box"><span>SD</span><img class="receipt-logo-inline" src="${RECEIPT_LOGO_SRC}" alt="SD" onerror="this.style.display='none';this.parentElement.classList.add('logo-fallback-active')"></div><div class="short-copy-v153"><h2>SD COMAYAGUA</h2><p class="short-meta short-meta-v50"><span class="short-client-name">${escapeHtml(doc.client||'Cliente')}</span><em class="short-date-time">${nowHN()}</em></p>${variant}</div></div>${shortReceiptLinesHTML(doc)}<hr><div class="short-line"><span>Productos</span><b>${money(c.products)}</b></div><div class="short-line"><span>${shippingLabel(doc)}</span><b>${money(c.shipping)}</b></div>${c.commission?`<div class="short-line"><span>Comisión</span><b>${money(c.commission)}</b></div>`:''}<div class="grand short-line"><span>Total</span><b>${money(c.total)}</b></div><small>WhatsApp +504 3151-7755</small></div>`;
  }
