(function(){
  ...
  function inventoryHeadHTML(count){return `<div class="section-head inventory-head-v31"><div><h2>INVENTARIO</h2><p>Productos sincronizados con Google Sheets.</p></div><div class="inventory-head-actions"><button class="inventory-new-btn" data-action="newProduct" type="button">+ Nuevo producto</button>${inventoryControls()}<span class="count-pill">${count} resultados</span></div></div>`}
  ...
  function pageFooter(){
    ...
    return `<footer class="sdc-page-footer no-print footer-v4911"><div class="footer-main"><div><b>SD COMAYAGUA</b><span>Fin del inventario · Actualizado ${escapeHtml(updated)}</span></div><small>WhatsApp +504 3151-7755 · Comayagua, Honduras</small></div><div class="footer-best"><strong>Más vendidos</strong><div>${bestSellersFooter()}</div></div><div class="footer-services"><span>🚚 Envío normal Lps. 110</span><span>📦 Pagar al recibir: Lps. 110 + 6%</span><span>🎁 Regalos descuentan stock</span></div></footer>`
  }
