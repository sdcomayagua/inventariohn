...
(function(){
  ...
  function quickPanel(){
    ...
    const alerts=[
      ['📦',`${low} bajo stock`,'Productos que conviene reponer.','lowStock','Ver'],
      ['🧾',`${nocost} sin costo`,'Agrega costo para ganancia real.','noCost','Revisar'],
      ['📉',`${lowMargin} ganancia baja`,'Menos de Lps. 10 por unidad.','lowProfit','Detalle'],
    ...
    return `<section class="quick no-print quick-v22 quick-private quick-panel quick-panel-v72 home-tools-v83">
      <div class="home-tools-head-v83">
        <div class="home-tools-title-v83"><b>Panel rápido</b><span>Desliza hacia la derecha para ver más sin llenar media pantalla.</span></div>
