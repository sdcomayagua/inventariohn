...
window.SDC_CONFIG = {
  ...
  accessKey: '199311',
  // URL oficial de nube para SD COMAYAGUA. Ya queda precargada para no pegarla cada vez.
  // Si cambias de Apps Script, puedes reemplazarla desde el botón Nube dentro de la página.
  syncUrl: 'https://script.google.com/macros/s/AKfycbxRhSkmnCOPEM-EHeOwYoAkDuGhzCbBRkxWOnpMPWLsKdoEgRenh5WjHTPS4yLUYaUr/exec',
  syncPin: '',
  syncAuto: true,
  codPercent: 6,
  lowStockLimit: 3,
