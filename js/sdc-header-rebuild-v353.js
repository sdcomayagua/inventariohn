/* v356 · Header más limpio: escritorio bajo y móvil compacto.
   No toca inventario, ventas, productos ni Firebase. */
(function(){
  'use strict';
  ...
  function addStyles(){
    if(document.getElementById('sdc356-header-style')) return;
    var css = `
...
.sdc353-hero{position:relative!important;isolation:isolate!important;width:calc(100vw - 92px)!important;max-width:1760px!important;min-height:138px!important;margin:28px auto 18px!important;padding:22px 28px!important;border-radius:28px!important;overflow:hidden!important;display:grid!important;grid-template-columns:88px minmax(0,1fr) auto auto!important;grid-template-areas:"logo brand actions status"!important;column-gap:24px!important;row-gap:0!important;align-items:center!important;border:1px solid rgba(255,255,255,.45)!important;background:radial-gradient(circle at 88% 28%,rgba(47,161,255,.32),transparent 27%),linear-gradient(130deg,#061934 0%,#073671 46%,#0b7eea 100%)!important;box-shadow:0 22px 52px rgba(6,31,63,.15),inset 0 1px 0 rgba(255,255,255,.28)!important}
...
.sdc353-hero:after{content:"";position:absolute;right:-70px;top:-82px;width:360px;height:280px;z-index:-1;opacity:.22;background-image:radial-gradient(rgba(255,255,255,.42) 1px,transparent 1.7px);background-size:11px 11px;border-radius:999px}.sdc353-glow{display:none!important}
.sdc353-logo-wrap{grid-area:logo!important;display:grid!important;place-items:center!important;width:84px!important;height:84px!important;border-radius:23px!important;justify-self:center!important;align-self:center!important;background:rgba(255,255,255,.96)!important;border:1px solid rgba(255,255,255,.78)!important;box-shadow:0 16px 34px rgba(0,13,43,.26),inset 0 1px 0 rgba(255,255,255,.9)!important}.sdc353-logo{display:block!important;width:68px!important;height:68px!important;max-width:68px!important;max-height:68px!important;object-fit:contain!important;border-radius:18px!important;padding:0!important;background:transparent!important;box-shadow:none!important}
.sdc353-brand{grid-area:brand!important;width:100%!important;min-width:0!important;max-width:100%!important;overflow:visible!important;align-self:center!important;justify-self:start!important;display:flex!important;flex-direction:column!important;justify-content:center!important;align-items:flex-start!important}.sdc353-pill{display:inline-flex!important;width:max-content!important;margin:0 0 8px!important;padding:6px 12px!important;border-radius:999px!important;border:1px solid rgba(255,255,255,.20)!important;background:rgba(255,255,255,.13)!important;color:#eaf5ff!important;font-size:11px!important;line-height:1!important;font-weight:950!important;letter-spacing:.06em!important;text-transform:uppercase!important}.sdc353-brand h1{margin:0!important;color:#fff!important;width:auto!important;max-width:100%!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important;font-size:clamp(36px,3.25vw,54px)!important;line-height:.94!important;letter-spacing:-.055em!important;font-weight:1000!important;text-shadow:0 8px 24px rgba(0,0,0,.20)!important}.sdc353-brand p{margin:9px 0 0!important;max-width:100%!important;color:rgba(227,241,255,.88)!important;font-size:clamp(12px,.95vw,15px)!important;line-height:1.18!important;font-weight:950!important;letter-spacing:.025em!important;text-transform:uppercase!important;white-space:normal!important}
.sdc353-actions{grid-area:actions!important;justify-self:end!important;align-self:center!important;width:auto!important;display:flex!important;flex-wrap:nowrap!important;align-items:center!important;justify-content:flex-end!important;gap:9px!important}.sdc353-btn{appearance:none!important;border:1px solid rgba(255,255,255,.24)!important;min-height:46px!important;height:46px!important;padding:0 16px!important;border-radius:15px!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;color:#fff!important;font-size:14px!important;line-height:1!important;font-weight:950!important;letter-spacing:-.02em!important;cursor:pointer!important;white-space:nowrap!important;box-shadow:0 12px 24px rgba(0,25,73,.16),inset 0 1px 0 rgba(255,255,255,.20)!important}.sdc353-btn svg{display:block!important;width:20px!important;height:20px!important;fill:none!important;stroke:currentColor!important;stroke-width:2.6!important;stroke-linecap:round!important;stroke-linejoin:round!important}.sdc353-menu{min-width:112px!important;background:rgba(255,255,255,.13)!important;backdrop-filter:blur(14px)!important}.sdc353-fire,.sdc353-update{background:linear-gradient(135deg,#168bff 0%,#006be7 100%)!important}.sdc353-fire{min-width:132px!important}.sdc353-update{min-width:150px!important}
.sdc353-status{grid-area:status!important;justify-self:end!important;align-self:center!important;position:relative!important;min-width:230px!important;width:auto!important;min-height:52px!important;padding:9px 15px 9px 40px!important;border-radius:16px!important;display:flex!important;flex-direction:column!important;justify-content:center!important;align-items:flex-start!important;background:rgba(255,255,255,.13)!important;border:1px solid rgba(255,255,255,.18)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.18),0 12px 28px rgba(0,18,58,.12)!important;color:#eaf5ff!important;backdrop-filter:blur(14px)!important}.sdc353-dot{position:absolute!important;left:16px!important;top:16px!important;width:11px!important;height:11px!important;border-radius:999px!important;background:#2df0a2!important;box-shadow:0 0 0 5px rgba(45,240,162,.13),0 0 16px rgba(45,240,162,.7)!important}.sdc353-status b{color:#36f6a8!important;font-size:13px!important;line-height:1!important;font-weight:1000!important;letter-spacing:.05em!important}.sdc353-status small{display:block!important;margin-top:5px!important;color:rgba(232,244,255,.86)!important;font-size:12px!important;line-height:1.15!important;font-weight:850!important}
body.sdc-v353-header-rebuild .sdc349-premium-tabs,body.sdc-v353-header-rebuild .sdc328-main-tabs{margin-top:0!important}
@media (min-width:761px) and (max-width:1380px){.sdc353-hero{width:calc(100vw - 54px)!important;grid-template-columns:78px minmax(0,1fr) auto!important;grid-template-areas:"logo brand status" "logo actions actions"!important;row-gap:12px!important;padding:22px 24px!important}.sdc353-logo-wrap{width:78px!important;height:78px!important}.sdc353-logo{width:63px!important;height:63px!important}.sdc353-brand h1{font-size:clamp(34px,4.1vw,50px)!important}.sdc353-actions{justify-self:start!important}.sdc353-status{min-width:210px!important}}
@media (min-width:761px) and (max-width:980px){.sdc353-hero{grid-template-columns:74px minmax(0,1fr)!important;grid-template-areas:"logo brand" "actions actions" "status status"!important;row-gap:12px!important}.sdc353-brand h1{white-space:normal!important}.sdc353-actions,.sdc353-status{justify-self:start!important}.sdc353-actions{width:100%!important;display:grid!important;grid-template-columns:1fr 1fr 1fr!important}.sdc353-btn{width:100%!important;min-width:0!important}}
...
`;
  ...
  function makeBtn(cls,label,kind,original,action){var btn=document.createElement('button'); btn.type='button'; btn.className='sdc353-btn '+cls; btn.innerHTML='<span class="sdc353-btn-icon">'+icon(kind)+'</span><span>'+label+'</span>'; btn.addEventListener('click',function(ev){ev.preventDefault(); ev.stopPropagation(); try{if(action) return action(btn); if(original && original.click) return original.click();}catch(error){console.warn('SDC v356: no se pudo ejecutar botón', label, error);}}); return btn;}
  ...
  function removeDuplicateUpdate(){document.querySelectorAll('.sdc353-hero .sdc344-update-app-btn,.sdc353-hero .sdc344-update-app-slot').forEach(function(el){el.remove();});}
  ...
  function install(){
    ...
    document.body.classList.add('sdc-v353-header-rebuild','sdc-v354-header-final','sdc-v355-mobile-compact','sdc-v356-desktop-clean');
    made=true;
  }
