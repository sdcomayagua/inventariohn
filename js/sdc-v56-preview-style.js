(function(){
  ...
  const BAD_COLOR_RE = /(18e7ff|18b9ff|28f6a1|00e5ff|22d8ff|25dfff|24e8ff|27defe|28c7e8|34f2b6|41e8ff|58d7ff|cyan|turquoise|rgb\(\s*24\s*,\s*231\s*,\s*255\s*\)|rgb\(\s*40\s*,\s*246\s*,\s*161\s*\)|rgb\(\s*34\s*,\s*216\s*,\s*255\s*\))/i;
  const VARS = {
    '--cyan':'#07182b',
    '--mint':'#ad2834',
    '--green':'#ad2834',
