(function(){
  ...
  const THEMES=['red','blue','gamer'];
  const LABEL={red:'Rojo',blue:'Azul',gamer:'Gamer'};
  const ICON={red:'●',blue:'◆',gamer:'🎮'};
  let busy=false;
  ...
  function setTheme(theme, silent){
    ...
    document.body.classList.toggle('sdc-theme-gamer', clean==='gamer');
    document.body.classList.remove('sdc-theme-dark','sdc-v57-dark','pro-dark-mode','dark-mode');
    localStorage.setItem(KEY, clean);
    const meta=document.querySelector('meta[name="theme-color"]');
    if(meta) meta.setAttribute('content', clean==='gamer'?'#020617':'#061522');
    updateThemePanel();
